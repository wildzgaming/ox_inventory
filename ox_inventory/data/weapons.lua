return {
	Weapons = {
        ...
        ['WEAPON_M906'] = {
            label = 'Zoraki M906 Stalker',
            weight = 1444,
            durability = 0.1,
            ammoname = 'ammo-blanks',
        },
        ...
        ['WEAPON_GLOCK20BB'] = {
            label = 'Glock 20 Airsoft',
            weight = 1295,
            durability = 0.1,
            ammoname = 'ammo-metalbbs',
        },
        
        ['WEAPON_G19BB'] = {
            label = 'Glock 19x Airsoft',
            weight = 1000,
            durability = 0.1,
            ammoname = 'ammo-metalbbs',
        },
        ...
        ['WEAPON_PAINTGUN'] = {
            ...
            weight = 950,
            durability = 0.2,
            ammoname = 'ammo-pellets'
        },
        
        ['WEAPON_BEANBAG'] = {
            label = 'Less Lethal Shotgun',
            weight = 950,
            durability = 0.2,
        ...
        ['WEAPON_SPRINGFIELD'] = {
            label = 'Springfield Armoury Hellcat',
            weight = 530,
            durability = 0.1,
            ammoname = 'ammo-9'
        },
        ...
        ['WEAPON_M37'] = {
            label = 'Ithaca M37 Trench Shotgun',
            weight = 6700,
            durability = 0.9,
            ammoname = 'ammo-shotgun'
        },
		...
		['WEAPON_HALLOWEENGLOCK'] = {
			label = 'Halloween Glock',
			weight = 10,
			durability = 0.03,
			ammoname = 'ammo-9',
		},
	...
	Components = {
		...
		['at_clip_extended_pistol'] = {
			...
			client = {
				component = {
					`COMPONENT_GLITTERGLOCK_CLIP_02`,
				},
				usetime = 2500
			}
		},  
		...
		['at_clip_extended_rifle'] = {
			...
			client = {
				component = {
					`COMPONENT_MCMG_CLIP_02`,
					`COMPONENT_2TONEARP_CLIP_02`,
					`COMPONENT_PSARP_CLIP_02`,
					`COMPONENT_PINKAR15_CLIP_02`,
				},
				usetime = 2500
			}
		},
		...
		['macextendedclip'] = {
			label = 'Mac Extended Clip',
			type = 'magazine',
			weight = 280,
			client = {
				component = {`COMPONENT_MAC10_CLIP_02`},
				usetime = 2500
			}
		},
		...
		['glockextendedclip'] = {
			label = 'Glock Extended Clip',
			type = 'magazine',
			weight = 280,
			client = {
				component = {`w_pi_g18_mag2`, `glock40mag2`, `glock26mag2`, `glock30mag2`, `glock17mag2`, `glock19mag2`, `g26mag2`, `glock19xmag2`, `glock17mag2`, `glock40mag2`, `glock43x2` },
				usetime = 2500
			}
		},
		
		['glockextendedclipclear'] = {
			label = 'Glock Extended Clip Clear',
			type = 'magazine',
			weight = 280,
			client = {
				component = {`glock40mag4`, `glock26mag4`, `glock30mag4`, `glock17mag4`, `glock19mag4`, `g26mag4`, `glock19xmag4`, `glock17mag4`, `glock40mag4`, `glock43x4` },
				usetime = 2500
			}
		},
		
		['springfieldextendedclip'] = {
			label = 'Springfield Extended Clip',
			type = 'magazine',
			weight = 280,
			client = {
				component = {`springfieldmag2`, `mpmag2`},
				usetime = 2500
			}
		},
		
		['glockdrumclip'] = {
			label = 'Glock Drum Clip',
			type = 'magazine',
			weight = 280,
			client = {
				component = {`w_pi_g18_mag3`, `glock40mag3`, `glock26mag3`, `glock30mag3`, `glock17mag3`, `glock19mag3`, `glock19xmag3`},
				usetime = 2500
			}
		},
		
		['arpistoldrum'] = {
			label = 'AR Pistol Drum Magazine',
			type = 'magazine',
			weight = 680,
			client = {
				component = {`COMPONENT_ARPISTOL_CLIP_02`},
				usetime = 2500
			}
		},
